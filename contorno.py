...
img = cv2.imread('/Users/annaplima/Downloads/FEI-CC7711-VisaoComputacional-main/CASTELO_01.jpeg')
...
a = img_gray.max()
_, thresh = cv2.threshold(img_gray, a/2.20*1.50, a,cv2.THRESH_BINARY_INV)
